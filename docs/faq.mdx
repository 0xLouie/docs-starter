...
The public map is a **curated beta** of 78 sample hotspots in New York City. The
...
Yes — a read-only API over the New York City beta dataset. Three `GET` endpoints, no
